   ...
   procedure Start_Task is
     ...
     task T1;
      ...
      begin
         ...
         Put_Line("T1 is finished the waiting");
         --copy q, MC
         ...
         for k in 1..H loop
            for i in 1..N loop
               MA(k)(i):=0;
               for j in 1..N loop
                  MA(k)(i):=MA(k)(i)+MB(k)(j)*MC1(j)(i);
               end loop;
               MA(k)(i):=MA(k)(i) + q*ME(k)(i);
               if a1<MA(k)(i) then
                  a1:= MA(k)(i);
               end if;
            end loop;
      ...
      begin
         ...
         Put_Line("T2 is finished the waiting");
         --copy q, MC
         Suspend_Until_True(Sc);
         Put_Line("T2 copies");
         q2:=q;
         ...
         --counting
         for k in H+1..2*H loop
            for i in 1..N loop
               MA(k)(i) := 0;
               for j in 1..N loop
                  MA(k)(i):=MA(k)(i)+MB(k)(j)*MC2(j)(i);
               end loop;
               MA(k)(i):=MA(k)(i) + q*ME(k)(i);
               if a2<MA(k)(i) then
                  a2:= MA(k)(i);
      ...
      begin
         ...
         Put_Line("T3 is finished the waiting");
         --copy q, MC
         Suspend_Until_True(Sc);
         Put_Line("T3 copies");
         q3:=q;
         ...
         --counting
         for k in 2*H+1..3*H loop
            for i in 1..N loop
               MA(k)(i) := 0;
               for j in 1..N loop
                  MA(k)(i):=MA(k)(i)+MB(k)(j)*MC3(j)(i);
               end loop;
               MA(k)(i):=MA(k)(i) + q*ME(k)(i);
               if a3<MA(k)(i) then
                  a3:= MA(k)(i);
         ...
         --signal to T1 about finishing of the work
         Set_True(S14);
      ...
      begin
         ...
         Put_Line("T4 is finished the waiting");
         --copy q, MC
         Suspend_Until_True(Sc);
         Put_Line("T4 copies");
         q4:=q;
         ...
         --counting
         for k in 3*H+1..4*H loop
            for i in 1..N loop
               MA(k)(i) := 0;
               for j in 1..N loop
                  MA(k)(i):=MA(k)(i)+MB(k)(j)*MC4(j)(i);
               end loop;
               MA(k)(i):=MA(k)(i) + q*ME(k)(i);
               if a4<MA(k)(i) then
                  a4:= MA(k)(i);
